...
class CPDDatasets:
    ...
    def get_dataset_(self) -> Tuple[Dataset, Dataset]:
        ...
        if self.experiments_name == "mnist":
            ...
            path_to_data = "/home/eromanenkova/kl_cpd_for_video/data/explosion/"
            ...
            train_dataset = UCFVideoDataset(clip_length_in_frames=16, step_between_clips=5, 
                                            ...
                                            path_to_annotation='/home/eromanenkova/kl_cpd_for_video/data/explosion/UCF_train_time_markup.txt', 
            ...
            test_dataset = UCFVideoDataset(clip_length_in_frames=16, step_between_clips=16, 
                                           path_to_data=path_to_data, 
                                           path_to_annotation='/home/eromanenkova/kl_cpd_for_video/data/explosion/UCF_test_time_markup.txt', 
                                           video_transform=transform,
...
class MNISTSequenceDataset(Dataset):
    ...
    def __init__(self, path_to_data: str, 
                 type_seq: str = "all", baseline: bool = False, anomaly_rate: float = None) -> None:
        ...
        #if anomaly_rate:
        #    anomaly_rate = int(anomaly_rate * len(self.path_with_change))
        #    self.with_change_seq_paths = random.sample(list(np.arange(len(self.path_with_change))), anomaly_rate)            
